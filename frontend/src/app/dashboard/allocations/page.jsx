                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-right">
                      <button
                        ...
                        className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl text-xs font-semibold text-rose-700 hover:bg-rose-100 bg-rose-50 border border-rose-200 transition-all disabled:opacity-50 shadow-xs"
                      >
